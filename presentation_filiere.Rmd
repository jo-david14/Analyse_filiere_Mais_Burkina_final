...
.resultat[
**Le Maïs domine le paysage agricole burkinabè** : C'est la 1ère culture en termes de superficie mobilisée et la 1ère culture vendue sur le territoire des hommes intègres**
]

---

# Consommation & Dépendance du Marché
...
.center[
.alerte[
**Constat clé :** L'autoconsommation ne représente que **42.79 %** des approvisionnements en maïs une part non negligeable. Les ménages achètent la majeure partie sur le marché.
]]]
...
.resultat[
**Analyse du commerce :** Bien que le maïs ne soit pas la filière la plus commercialisée dans les échanges, il présente un enjeu majeur.Il est peu importe ce qui revele certainement une bonne capacite de prise en charge nationalement et fait parti du top 10 des produits les plus exportes 
]
...
.alerte[
**Intérêt théorique :**  
Cette classification permet d'isoler l'effet direct de l'autoconsommation vs. la vulnérabilité liée aux chocs de prix sur les marchés.
]

<br>
.center[
```{r m2-fies, out.width="90%"}
knitr::include_graphics("sorties/graph_m2_fies.png")
```
]
]
...
.resultat[
**Lecture du tableau :** Les ménages **Producteurs-Consommateurs** affichent la meilleure sécurité alimentaire (Score FIES le plus bas, 2,9) malgré une pauvreté monétaire élevée — l'autoconsommation protège efficacement contre la faim. À l'inverse, le groupe **"Ni producteur ni consommateur"** cumule le score FIES le plus élevé (3,5) et le taux de pauvreté le plus fort (47,9 %), confirmant leur double vulnérabilité, hors filière maïs.
]
...
6 Les statistiques de FAOSTAT correspondent à une estimation théorique de la production nationale. 
]
]
...
knitr::include_graphics("sorties/graph_m4_marge.png")
```
]
.resultat[
**Forte disparité régionale :** La marge varie de **887 FCFA/kg** dans les régions les plus rentables à des **marges négatives** (jusqu'à -165 FCFA/kg) dans les régions 1 et 13.
]
]
